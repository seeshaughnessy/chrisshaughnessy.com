...
function custom_post_example() { 
	...
	register_post_type( 'portfolio', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Portfolio Items', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Portfolio Item', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Portfolio Items', 'jointswp'), /* the all items menu item */
			...
			'description' => __( 'This is the portfolio post type', 'jointswp' ), /* Custom Type Description */
			'public' => true,
